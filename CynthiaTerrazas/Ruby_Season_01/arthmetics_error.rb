class Arthmetics_error
  ...
  puts "Ariel pay:#{ariel_bill + half_tip}" # this is the error because 'half_tip' is undefined local variable  for Arthmetics_error Class. this variable does not exist.
